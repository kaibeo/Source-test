...
local sentFullMoon = true
local previousSword = true
local sentLegendarySword = true
local PrehistoricSpawned = true
local MirageSpawned = true
local sentFruit = true
local sentDoughKing = true
local sentRipIndra = true
local sentCursedCaptain = true
local sentCakePrince = true
local sentSoulReaper = true
local sentBossEvent = true
local sentHakiLegendary = true
local previousSea = true
local lastBerryKey = ""
